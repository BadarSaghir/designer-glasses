            ...
            <div>
                    ...
                    <div className="w-full h-full  " id="chec-div">
                        <div className="w-full  h-full " id="checkout">
                            <div className="flex md:flex-row p-16 flex-col justify-end" id="cart">
                                <div className="lg:w-[100%] w-full md:pl-10 pl-4 pr-10 md:pr-4 md:py-12 py-8 bg-white overflow-x-hidden h-screen" id="scroll">
                                    ...
                                    <div className="md:flex items-center mt-14 py-8 border-t border-gray-200">
                                        <div className="w-1/4">
                                            <img src="https://cdn.tuk.dev/assets/templates/e-commerce-kit/bestSeller3.png"  className="w-full h-full object-center object-cover" alt="s" />
                                        </div>
