...
const Products = ({ products }: ProductsProps) => {
  ...
  return (
    <div className="w-full h-full flex flex-col pb-24">
      ...
      <div className=" flex flex-col justify-center items-center px399:grid  gap-12 grid-cols-1 px399:grid-cols-2 pl-[20%] pr-[20%] pt-5  sm:grid-cols-2 px1260:grid-cols-3   sm:p-24 md:gap-6 lg:gap-6 h-full w-full">
